...
import com.mycompany.trashbasketball.security.SecurityUtils;
import com.mycompany.trashbasketball.service.MailService;
...
import com.mycompany.trashbasketball.web.rest.errors.*;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        scoreService.createUserScore(user.getId(),user.getLogin());
    }
